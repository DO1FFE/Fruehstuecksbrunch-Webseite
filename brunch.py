    ...
    return render_template_string("""
        ...
        <body class="bg-gray-100">
            <div class="container mx-auto px-4">
                ...
                <h2 class="text-3xl font-bold text-center my-6">Teilnehmende Personen (ohne Kaffeetrinker): {{ total_participants_excluding_coffee_only }}, Kaffeetrinker: {{ coffee_only_participants }}</h2>
