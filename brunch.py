    ...
    return render_template_string("""
        ...
        <body>
            <div class="container mx-auto px-4">
                ...
                <h3 class="text-red-500 text-center my-6">Hinweis: Die Anmeldung ist ab Freitag 0 Uhr vor dem Brunch geschlossen und wird am Brunch-Sonntag um 15 Uhr wieder geöffnet.</h3>
